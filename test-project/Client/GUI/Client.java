...
public   class  Client {
  ...
  private static volatile volatile boolean swingStarted  = false;
  ...
  protected volatile volatile Thread senderThread  = null;

	
  protected volatile volatile boolean senderRunning  = false;
  ...
  private void  onStart__wrappee__src(final Socket socket) {
  ...
  private void  onStop__wrappee__src  (final Socket socket) {
   ...
   */
  private String  send__wrappee__src  (String text) {
  ...
  protected String send  (String text) {
    ...
    // DO NOT call send__wrappee__src(text) here — UI is responsible for invoking pre/post pipeline in refinements.
  ...
  public static   class  SwingApp {
    ...
    private static volatile volatile SendHandler SEND_HANDLER  ;
